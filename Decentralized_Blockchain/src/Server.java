...
public class Server {
    ...
    public ArrayList<Socket> MY_PEERS = new ArrayList<>();
    ...
    public static String calculateHash(String stringToHash) {
        try {
            ...
            return Server.bytesToHex(encodedHash);
    ...
    public void SocketServer(int port) {
        new Thread(() -> {
            System.out.println("SocketServer: " + port);
    ...
    //client
    public void SocketClient(String address, int port) {
        new Thread(() -> {
            ...
            try {
                ...
                MY_PEERS.add(socket);
                System.out.println(MY_PEERS.toString());
    ...
    public void broadcastBlock(Block block) {
        ...
        System.out.println("MY_PEERS: " + MY_PEERS.size());

        for (Socket peer : MY_PEERS) {
            try {
